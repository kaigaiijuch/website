...
ActiveRecord::Schema[7.1].define(version: 2025_08_03_093001) do
  ...
  create_table "episode_photos", force: :cascade do |t|
    t.string "episode_number", null: false
    t.string "image_path", null: false
    t.index ["episode_number"], name: "index_episode_photos_on_episode_number", unique: true
  end
  ...
  create_table "guest_interview_profile_sns_instagrams", force: :cascade do |t|
    t.integer "guest_interview_profile_id", null: false
    t.string "account", null: false
    t.index ["guest_interview_profile_id"], name: "idx_on_guest_interview_profile_id_b0d57bd7a9"
  end
  ...
  create_table "host_roles", id: false, force: :cascade do |t|
    t.string "name", null: false
    t.index ["name"], name: "index_host_roles_on_name", unique: true
  end
  ...
  add_foreign_key "episode_photos", "episodes", column: "episode_number", primary_key: "number"
  ...
  add_foreign_key "guest_interview_profile_sns_instagrams", "guest_interview_profiles"
