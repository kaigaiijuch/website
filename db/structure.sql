...
CREATE TABLE IF NOT EXISTS "guest_interviews" ("episode_number" varchar NOT NULL, "guest_info_id" integer NOT NULL, "display_order" integer DEFAULT 1 NOT NULL, CONSTRAINT "fk_rails_c2329fd873"
