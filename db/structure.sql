...
CREATE TABLE IF NOT EXISTS "hosts" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "url" varchar DEFAULT NULL, "title" varchar NOT NULL, "description" varchar DEFAULT NULL);
