...
CREATE TABLE IF NOT EXISTS "episode_photos" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "episode_number" varchar NOT NULL, "image_path" varchar NOT NULL, "display_order" integer DEFAULT 1 NOT NULL, "caption" text DEFAULT NULL, CONSTRAINT "fk_rails_eb9cadcb0a"
...
CREATE TABLE IF NOT EXISTS "episodes" ("number" varchar NOT NULL PRIMARY KEY, "title" varchar(200) NOT NULL, "summary" text NOT NULL, "introduction" text NOT NULL, "season_number" integer DEFAULT NULL, "story_number" integer DEFAULT NULL, "type_name" varchar NOT NULL, "image_path" varchar NOT NULL, "place" varchar, CONSTRAINT "fk_rails_eafa210e4e"
