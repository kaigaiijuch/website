...
CREATE TABLE IF NOT EXISTS "episode_speaker_transcriptions" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "episode_speaker_id" integer NOT NULL, "text" text NOT NULL, "start_at" varchar NOT NULL, "end_at" varchar NOT NULL, CONSTRAINT "fk_rails_a0096161e0"
...
CREATE TABLE IF NOT EXISTS "episode_speakers" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "episode_number" varchar NOT NULL, "speaker_id" integer NOT NULL, "role_name" varchar NOT NULL, CONSTRAINT "fk_rails_1adb9b5693"
FOREIGN KEY ("episode_number")
  REFERENCES "episodes" ("number")
...
CREATE TABLE IF NOT EXISTS "episodes" ("number" varchar NOT NULL PRIMARY KEY, "title" varchar(200) NOT NULL, "summary" text NOT NULL, "introduction" text NOT NULL, "season_number" integer DEFAULT NULL, "story_number" integer DEFAULT NULL, "type_name" varchar NOT NULL, "image_path" varchar NOT NULL, "place" varchar DEFAULT NULL, CONSTRAINT "fk_rails_eafa210e4e"
...
CREATE TABLE IF NOT EXISTS "guest_interview_profile_sns_instagrams" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "guest_interview_profile_id" integer NOT NULL, "account" varchar NOT NULL, CONSTRAINT "fk_rails_aa802b731d"
FOREIGN KEY ("guest_interview_profile_id")
  REFERENCES "guest_interview_profiles" ("id")
);
CREATE INDEX "idx_on_guest_interview_profile_id_b0d57bd7a9" ON "guest_interview_profile_sns_instagrams" ("guest_interview_profile_id");
...
CREATE TABLE IF NOT EXISTS "guest_interviews" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "episode_number" varchar NOT NULL, "guest_interview_profile_id" integer NOT NULL, "display_order" integer DEFAULT 1 NOT NULL, "interviewed_on" date NOT NULL, CONSTRAINT "fk_rails_6e428d54d7"
FOREIGN KEY ("episode_number")
  REFERENCES "episodes" ("number")
...
CREATE TABLE IF NOT EXISTS "questions" ("number" varchar NOT NULL PRIMARY KEY, "text" text NOT NULL, "display_order" integer NOT NULL, "topic_code" varchar NOT NULL, "about" varchar NOT NULL, CONSTRAINT "fk_rails_251e626c71"
...
/* published_episodes(number,title,summary,introduction,season_number,story_number,type_name,image_path,place,episode_number,source_url,"title:1",url,audio_file_url,image_url,published_at,description,duration,explicit,"season_number:1","story_number:1",episode_type,guid,creator) */;
...
/* unpublished_episodes(number,title,summary,introduction,season_number,story_number,type_name,image_path,place,episode_number,source_url,"title:1",url,audio_file_url,image_url,published_at,description,duration,explicit,"season_number:1","story_number:1",episode_type,guid,creator) */;
CREATE TABLE IF NOT EXISTS "schema_migrations" ("version" varchar NOT NULL PRIMARY KEY);
CREATE TABLE IF NOT EXISTS "ar_internal_metadata" ("key" varchar NOT NULL PRIMARY KEY, "value" varchar, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
CREATE TABLE IF NOT EXISTS "episode_photos" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "episode_number" varchar NOT NULL, "image_path" varchar NOT NULL, "display_order" integer DEFAULT 1 NOT NULL, "caption" text DEFAULT NULL, "width_percent" integer DEFAULT 100 NOT NULL, CONSTRAINT "fk_rails_eb9cadcb0a"
FOREIGN KEY ("episode_number")
  REFERENCES "episodes" ("number")
, CONSTRAINT check_display_order_positive CHECK (display_order > 0));
